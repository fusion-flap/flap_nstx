    ...
    if not nocalc:
        ...
        for i_frames in range(0,n_frames-2):
            ...
            if return_pixel_displacement:
                ...
                frame_properties['Velocity ccf'][i_frames,0]=(spatial_calibration[0]*delta_index[0]+
                                                              spatial_calibration[1]*delta_index[1]+
                                                              spatial_calibration[2]*delta_index[0]*delta_index[1])/sample_time
                
                frame_properties['Velocity ccf'][i_frames,1]=(spatial_calibration[4]*delta_index[0]+
                                                              spatial_calibration[5]*delta_index[1]+
                                                              spatial_calibration[6]*delta_index[0]*delta_index[1])/sample_time   
